...
public class Certificate {
        ...
        public static final String CERTIFICATENAME = "证照名称";
        public static final String SCANFILE = "扫描件";
        public static final String CHECKTIME = "年检到期时间";
