...
-- Records of resource
-- ----------------------------
INSERT INTO `resource` VALUES ('1', '咨询', null, null, '0', '1', '1', null);
INSERT INTO `resource` VALUES ('2', '学员管理', null, null, '0', '2', '1', '');
INSERT INTO `resource` VALUES ('3', '收费', null, null, '0', '3', '1', null);
INSERT INTO `resource` VALUES ('4', '教务', null, null, '0', '4', '1', null);
INSERT INTO `resource` VALUES ('5', '系统', null, null, '0', '5', '1', null);
INSERT INTO `resource` VALUES ('6', '潜在学员', null, null, '1', '1', '2', 'grid.htm');
INSERT INTO `resource` VALUES ('7', '学员报名', null, null, '2', '1', '2', null);
INSERT INTO `resource` VALUES ('8', '学员记录', null, null, '2', '2', '2', null);
INSERT INTO `resource` VALUES ('9', '收费记录', null, null, '3', '1', '2', null);
INSERT INTO `resource` VALUES ('10', '课程类别', null, null, '4', '1', '2', null);
INSERT INTO `resource` VALUES ('11', '课程时段', null, null, '4', '2', '2', null);
INSERT INTO `resource` VALUES ('12', '班级管理', null, null, '4', '3', '2', null);
INSERT INTO `resource` VALUES ('13', '排课管理', null, null, '4', '4', '2', null);
INSERT INTO `resource` VALUES ('14', '用户管理', null, null, '5', '1', '2', null);
INSERT INTO `resource` VALUES ('15', '角色管理', null, null, '5', '2', '2', null);
INSERT INTO `resource` VALUES ('16', '模板', null, null, '0', '6', '1', null);
INSERT INTO `resource` VALUES ('17', '表格', null, null, '16', '1', '2', 'grid.htm');
INSERT INTO `resource` VALUES ('19', '表单', null, null, '16', '2', '2', 'form.htm');
INSERT INTO `resource` VALUES ('20', 'easyUi表格', null, null, '16', '3', '2', 'autocode/index.html');
INSERT INTO `resource` VALUES ('21', '档案管理', null, null, '16', '4', '2', 'file/index.html');
INSERT INTO `resource` VALUES ('22', '用印管理', null, null, '16', '5', '2', 'signet/index.html');
INSERT INTO `resource` VALUES ('23', '证照管理', null, null, '16', '6', '2', 'certificate/index.html');
INSERT INTO `resource` VALUES ('24', '差旅管理', null, null, '16', '7', '2', 'travel/index.html');
...
CREATE TABLE `t_certificate` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='证照管理';
...
CREATE TABLE `t_signet` (
  ...
  `is_deleted` tinyint(4) DEFAULT NULL COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='印章管理';
...
CREATE TABLE `t_signet_apply` (
  ...
  `is_deleted` tinyint(4) DEFAULT NULL COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用印申请';
...
CREATE TABLE `t_travel` (
  ...
  `expectcost` float(8,0) DEFAULT NULL COMMENT '预计花费',
  `cost` float(8,0) DEFAULT NULL COMMENT '实际花费',
  `gm_time` bigint(20) DEFAULT NULL COMMENT '总经理审批时间',
  `gm_result` varchar(10) DEFAULT NULL COMMENT '总经理审批结果',
  `gm_suggest` varchar(100) DEFAULT NULL COMMENT '总经理审批意见',
  `create_time` bigint(20) DEFAULT NULL COMMENT '创建时间',
